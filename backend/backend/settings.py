...
JAZZMIN_SETTINGS = {
    "site_title": "Salazar Library",
    "site_header": "Salazar Library",
    "site_brand": "Salazar Library",
...
EMAIL_PROVIDER = get_env_str('EMAIL_PROVIDER', 'auto').lower()
...
RESEND_API_BASE_URL = get_env_str('RESEND_API_BASE_URL', 'https://api.resend.com')
RESEND_FROM_EMAIL = get_env_str('RESEND_FROM_EMAIL', DEFAULT_FROM_EMAIL)
