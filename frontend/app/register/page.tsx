...
const REGISTER_HIGHLIGHTS = [
  ...
  { value: '1 OTP', label: 'Email verification' },
  { value: '1 review', label: 'Staff approval' },
];
          ...
          <div className="space-y-6 lg:pr-4 animate-fade-up">
            ...
            <div className="relative overflow-hidden rounded-[38px] border border-white/10 bg-white/[0.045] p-6 shadow-[0_32px_80px_rgba(2,6,23,0.45)] backdrop-blur-xl sm:p-8 xl:p-10">
              ...
              <div className="relative grid gap-6 xl:grid-cols-[minmax(0,1fr)_260px] xl:items-end">
                  ...
                  <div className="space-y-4">
                    <h1 className="max-w-3xl text-4xl font-extrabold leading-[0.93] tracking-tight text-white sm:text-6xl lg:text-[4.15rem] xl:text-[5rem]">
                      {recoveryMode ? (
                        ...
                        <>
                          Join the
                          <span className="block text-amber-200">SCSIT Digital Library.</span>
                        </>
                      )}
                    </h1>
                ...
                <div className="rounded-[26px] border border-white/10 bg-[#0d1729]/85 p-4 shadow-lg shadow-black/25">
                  ...
                  <div className="mt-4 grid gap-2">
                    {showcaseHighlights.map((item) => (
                      <div
                        key={item.label}
                        className="flex items-center justify-between rounded-[18px] border border-white/10 bg-white/[0.03] px-3.5 py-2.5"
                      >
