...
const contactHighlights = [
  {
    ...
    icon: (
      <svg className="h-5 w-5 text-[color:var(--accent-cool-strong)]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path
          strokeLinecap="round"
                ...
                <div className="public-panel overflow-hidden rounded-[2rem] backdrop-blur-xl animate-fade-up delay-200">
                  <div className="relative h-[30rem] overflow-hidden sm:h-[38rem]">
                    <Image
                      ...
                      className={
                        usePhotoFallback
                          ? 'object-contain bg-[color:var(--surface-muted)] p-6 sm:p-8'
            ...
            <div className="space-y-8 animate-fade-up delay-200 lg:pt-3">
              <div className="public-panel rounded-[28px] p-6 backdrop-blur-2xl transition-all duration-300 hover:-translate-y-1 sm:p-8 lg:p-10">
                ...
                <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
                  ...
                  {error && (
                    <div className="rounded-2xl border border-rose-300/40 bg-rose-50 px-4 py-3 text-sm text-rose-700 animate-fade-up">
                      {error}
                    </div>
                  )}
              ...
              <div className="public-panel-soft rounded-2xl p-6 text-sm text-ink-muted transition-all duration-300 hover:-translate-y-1 sm:p-7">
                <p className="text-xs uppercase tracking-[0.3em] text-[color:var(--accent-cool-strong)]/80">Quick links</p>
                <div className="mt-4 flex flex-col gap-3">
                  <Link
                    href="/books"
                    scroll
                    onClick={handleLowerLinkClick}
                    className="inline-flex w-fit text-[color:var(--accent-strong)] transition-all duration-200 hover:translate-x-1 hover:text-[color:var(--accent)]"
                  >
                    Browse books -&gt;
                  </Link>
                  <Link
